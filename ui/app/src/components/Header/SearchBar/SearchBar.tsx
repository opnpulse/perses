...
import { formatForDisplay } from '@openpulse/shared/dashboards/src/keyboard-shortcuts';
import { OPEN_SEARCH_EVENT } from '@openpulse/shared/dashboards/src/keyboard-shortcuts/events';
